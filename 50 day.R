...
write.csv(moving_avg_table, file = "moving_avg_results.csv", row.names = FALSE)

# Print a message indicating the file has been created
cat("CSV file 'moving_avg_results.csv' has been created.\n")
