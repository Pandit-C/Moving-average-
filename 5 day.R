# Install the TTR package if not already installed
...
# Add a legend
legend("topright", legend = c("Closing Price", "5-day SMA"), col = c("blue", "red"), lty = 1)
...
write.csv(moving_avg_table, file = "moving_avg_results5.csv", row.names = FALSE)

# Print a message indicating the file has been created
cat("CSV file 'moving_avg_results5.csv' has been created.\n")
